...
def get_args():
    ...
    parser.add_argument('-mm', '--mmode', type=str, default='b', choices=['c', 'b', 'e'], help='model mode')
...
cawn = CAWN(device,
            ngh_finder, train_node_set, max_idx, args.mmode, args.data, num_layers=NUM_LAYER,
...
cawn.to(device)
#cawn.load_state_dict(torch.load('./load/checkpoint-epoch-36.pth'))
